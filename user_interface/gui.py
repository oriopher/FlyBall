...
class Gui:
    ...
    left_camera_col = sg.Column([[sg.Text('Left Camera:'), sg.Checkbox('Flip', key='-FLIP_LEFT-')],
                            [sg.Listbox(['C920 1', 'C920 2'], size=(17,2), select_mode='extended', key='-LEFT_CAM-')]], element_justification='c')

    right_camera_col = sg.Column([[sg.Text('Right Camera:'), sg.Checkbox('Flip', key='-FLIP_RIGHT-')],
                            [sg.Listbox(['C920 1', 'C920 2'], size=(17,2), select_mode='extended', key='-RIGHT_CAM-')]], element_justification='c')
    ...
    layout = [ [sg.Frame('Cameras', [[left_camera_col, right_camera_col]]), sg.Frame('Color Bounds', [[color_bounds_col1, color_bounds_col2]])],
                ...
                [sg.Image(filename='', key='image_left'), sg.Image(filename='', key='image_right'), sg.Image(filename='', key='xy_display')],
