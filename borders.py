...
class Borders:
    ...
    def calc_borders(self):
        ...
        self.y_middle_1 = (self.coordinates[0][1] + self.coordinates[1][1] + self.coordinates[2][1] +
                           self.coordinates[3][1]) / 4
        self.x_middle_2 = 2 * (self.coordinates[0][0] + self.coordinates[1][0]) / 3
        self.y_middle_2 = (self.coordinates[0][1] + self.coordinates[1][1] + self.coordinates[2][1] +
                           self.coordinates[3][1]) / 4
